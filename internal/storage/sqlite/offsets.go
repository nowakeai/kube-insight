...
type ResourceHealthOptions = storage.ResourceHealthOptions

type ResourceHealthReport = storage.ResourceHealthReport

type ResourceHealthSummary = storage.ResourceHealthSummary

type ResourceHealthRecord = storage.ResourceHealthRecord
