...
AGENT_CASE_REQUIRED_TOOLS=${KUBE_INSIGHT_AGENT_CASE_REQUIRED_TOOLS:-kube_insight_health,kube_insight_schema,kube_insight_scripted_query}
AGENT_CASE_FORBIDDEN_TOOLS=${KUBE_INSIGHT_AGENT_CASE_FORBIDDEN_TOOLS:-artifact_transform_js}
