...
func agentRunClientContextMessage(metadata json.RawMessage) string {
	...
	b.WriteString("- Client locale and languages are UI formatting context only. Do not use them to choose the response language; answer in the language of the user's current prompt unless the user explicitly asks for another language.\n")
